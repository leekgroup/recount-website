...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        ...
        tags$ul(
            ...
            tags$li(HTML('<b>Razmara E</b>, Ellis SE, Sokolowski DJ, Davis S, Wilson MD, Leek JT, Jaffe AE, Collado-Torres L. <a href="https://www.biorxiv.org/content/10.1101/618025v1" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'recountbrain-biorxiv\', 1)">recount-brain: a curated repository of human brain RNA-seq datasets metadata</a>. <i>bioRxiv</i>, 2019. doi: 10.1101/618025.')),
            tags$li(HTML('<b>Luidy-Imada E</b>, <b>Matam T</b>, Collado-Torres L, Sanchez DF, Dinalankara W, Stupnikov A, Lobo-Pereira F, Wilks C, Jaffe AE, Langmead B, Leek JT, Favorov A, Franco GR, Marchionni L. <a href="https://www.biorxiv.org" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'fc-biorxiv\', 1)">A comprehensive atlas of human non-coding RNAs expression using a standarized pipeline</a>. <i>bioRxiv</i>, 2019. doi: 10.1101/xxx.'))
        ),
        tags$hr(),
        h3('The Datasets'),
    ...
    tabPanel('Documentation',
        ...
        p('RangedSummarizedExperiment object with the FANTOM-CAT/recount2 annotation counts. See', HTML('<a href="https://www.biorxiv.org/" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'fc-biorxiv\', 1)">Luidy-Imada, Matam et al, bioRxiv, 2019</a>'), ' for more information on how this annotation was determined. The rowRanges() slot is a GRangesList with one element per gene, and then exons coordinates for that given gene. For the md5sum and file size information for these files, please check the ', HTML('<a href="https://github.com/leekgroup/recount-website/blob/master/fileinfo/fc_rc_files_info.tsv" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'fc-biorxiv\', 1)">fc_rc_files_info.tsv</a>'), ' file.'),
        tags$hr(),
