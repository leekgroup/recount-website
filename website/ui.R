...
shinyUI(navbarPage(
    ...
    tabPanel('Documentation',
        h3('recount objects documentation'),
        ...
        h5('Annotation used'),
        p('The GFF3 file with the comprehensive gene annotation (CHR regions) is available at the ', HTML('<a href="https://www.gencodegenes.org/releases/25.html" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'gencode\', 1)">Gencode website</a>.')),
        tags$hr(),
        ...
        HTML('Some single-cell studies like SRP058046 sequenced more than one single-cell but are available only as a pooled sample from the Sequence Read Archive. Currently these studies might not be useful for differential expression analysis via recount but can be used for checking if a given exon-exon junction is present or if a given region is expressed. Reported by <a href="https://www.helmholtz-muenchen.de/icb/">Lukas Simon</a>.'),
        h5('Found an issue?'),
        HTML('If you found an issue with recount, please email us or describe the problem at the <a href="https://github.com/leekgroup/recount-website/issues">recount-website issue tracker</a>. Thank you!')
    ),
    ...
    tabPanel('Contribute your data',
        h3('Contribute your data to recount!'),
        HTML('If you are interested in contributing your human RNA-seq data sequenced on the Illumina platform to recount, please check how to do so at <a href="https://github.com/leekgroup/recount-contributions">recount-contributions</a>. Thank you!')
    ),
    tags$hr(),
