...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        ...
        HTML('<b>Collado-Torres L</b>, <b>Nellore A</b>, Kammers K, Ellis SE, Taub MA, Jaffe AE, Hansen KD, Langmead B, Leek JT. <a href="https://github.com/leekgroup/recount-website" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'github-recount-web\', 1)">Recount</a>. <i>Journal COMPLETE ME</i> <b>Volume</b> pages.'),
        tags$hr(),
        h3('The Datasets'),
