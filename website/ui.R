...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        HTML('<a href="https://github.com/leekgroup/recount-website">'), img(src='https://raw.githubusercontent.com/leekgroup/recount-website/master/website/recount.png', align = "left"), HTML('</a>'),
        ...
        tags$hr(),
        h3('Support'),
        p('If you need help with the recount R package please get in touch via the ', HTML('<a href="https://support.bioconductor.org/">Bioconductor support website</a>'), '(remember to use the ', strong('recount'), ' tag) or via the ', HTML('<a href="https://github.com/leekgroup/recount/issues">recount R package repository</a>.'), ' For support on reproducing the Recount project, please get in touch via the ', HTML('<a href="https://github.com/leekgroup/recount-website/issues">recount-website repository</a>.')),
        tags$hr(),
    ...
    tabPanel('Documentation',
        ...
        h5('RSE exon'),
        p('The RangedSummarizedExperiment object for the counts summarized at the exon level using the UCSC hg38 knownGene annotation as provided ', HTML('<a href="https://jhubiostatistics.shinyapps.io/recount/ucsc-knowngene-hg38-exons.Rdata">here</a>. This GRangesList object has 1 element per gene. For each gene this object contains the reduced exons such that they are non-overlapping within a gene.')),
        h5('counts gene'),
        ...
        h5('Code used'),
        HTML("The code for analyzing the <a href='http://rail.bio'>Rail-RNA</a> output and creating this website is available via <a href='https://github.com/leekgroup/recount-website'>GitHub</a>."),
        tags$hr(),
        p('This research was supported in part by COMPLETE ME. LCT was supported by Consejo Nacional de Ciencia y Tecnología México 351535.'),
        HTML('<a href="http://idies.jhu.edu/">'), img(src='http://idies.jhu.edu/wp-content/themes/idies/assets/img/idieslogo.png', align = "right"), HTML('</a>'),
        tags$br(),
