...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        ...
        HTML('<a href="https://github.com/leekgroup/recount-website" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'github-recount-web\', 1)">'), img(src='https://raw.githubusercontent.com/leekgroup/recount-website/master/website/recount.png', align = "left"), HTML('</a>'),
