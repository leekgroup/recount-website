...
shinyUI(navbarPage(
    ...
    tabPanel('Documentation',
        ...
        p('The link jx_bed points to the BED file with one entry per junction present in the given project. The name of the junction includes the junction id, the donor, acceptor, and overall (if present in both) transcript ids.'),
        h5('phenotype'),
    ...
    tabPanel('How to download with recount',
        tags$head(includeScript("google-analytics.js")),
        p('The following R code shows how to use the', HTML('<a href="http://bioconductor.org/packages/recount" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'bioc-recount\', 1)">recount</a>'), 'Bioconductor package for downloading data ', HTML('(for now only available via <a href="https://github.com/leekgroup/recount" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'github-recount\', 1)">GitHub</a>)'), '. In this example we will download the data for study SRP009615.'),
