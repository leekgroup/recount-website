...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        ...
        tags$ul(
            ...
            tags$li(HTML('<b>Kuri-Magaña H</b>, Collado-Torres L, Jaffe AE, Valdovinos-Torres H, Ovilla-Muñoz M, Téllez-Sosa JM, Bonifaz-Alfonzo LC, Martínez-Barnetche J. <a href="https://www.frontiersin.org/articles/10.3389/fimmu.2018.02679/full" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'ncCSR-frontimmmuno\', 1)">NNon-coding Class Switch Recombination-Related Transcription in Human Normal and Pathological Immune Responses</a>. <i>Front. Immunol.</i>, 2018. doi: 10.3389/fimmu.2018.02679.')),
            tags$li(HTML('<b>Ling JP</b>, Wilks C, Charles R, Ghosh D, Liang L, Santiago CP, Pang B, Venkataraman A, Clark BS, Nellore A, Lanmgead B, Blackshaw S. <a href="https://www.biorxiv.org/content/10.1101/501882v1" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'ascot-biorxiv\', 1)">ASCOT identifies key regulators of neuronal subtype-specific splicing</a>. <i>bioRxiv</i>, 2018. doi: 10.1101/384172.'))
        ),
        tags$hr(),
        h3('The Datasets'),
