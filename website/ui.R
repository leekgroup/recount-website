...
shinyUI(navbarPage(
    ...
    tabPanel('Datasets',
        ...
        tags$ul(
            ...
            tags$li(HTML('<b>Fu J</b>, Kammers K, Nellore A, Collado-Torres L, Leek JT, Taub MA. <a href="https://www.biorxiv.org/content/early/2018/01/12/247346" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'tx-biorxiv\', 1)">RNA-seq transcript quantification from reduced-representation data in recount2</a>. <i>bioRxiv</i>, 2018. doi: 10.1101/247346.')),
            tags$li(HTML('<b>Kuri-Magaña H</b>, Collado-Torres L, Jaffe AE, Valdovinos-Torres H, Ovilla-Muñoz M, Téllez-Sosa JM, Bonifaz-Alfonzo LC, Martínez-Barnetche J. <a href="https://www.biorxiv.org/content/early/2018/08/03/384172" onclick="ga(\'send\', \'event\', \'click\', \'link\', \'ncCSR-biorxiv\', 1)">Non-coding Class Switch Recombination-related transcription in human normal and pathological immune responses</a>. <i>bioRxiv</i>, 2018. doi: 10.1101/384172.'))
        ),
        tags$hr(),
        h3('The Datasets'),
